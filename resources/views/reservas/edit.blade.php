        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                            ...
                            <div>
                                ...
                                <span class="ml-2">{{ $reserva->user->name }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('reservas.update', $reserva) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea 
                                ...
                                required>{{ old('motivo', $reserva->motivo) }}</textarea>
                            @error('motivo')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <button type="button" 
                                        onclick="if(confirm('¿Estás seguro de que quieres eliminar esta reserva?')) { document.getElementById('delete-form').submit(); }"
                    ...
                    <form id="delete-form" method="POST" action="{{ route('reservas.destroy', $reserva) }}" class="hidden">
                        @csrf
                        @method('DELETE')
                    </form>
